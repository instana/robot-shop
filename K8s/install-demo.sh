...
helm upgrade --install robot-shop --namespace robot-shop --set "redis.storageClassName=gp2" --set "rabbitmq.enableExporter=true" helm

# check diff
# helm diff upgrade robot-shop --namespace robot-shop --set "redis.storageClassName=gp2" --set "rabbitmq.enableExporter=true" helm --allow-unreleased
